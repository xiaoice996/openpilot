...
procs = [
  ...
  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", driverview, enabled=DRIVER_CAMERA_ENABLED and (WEBCAM or not PC)),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", driverview, enabled=DRIVER_CAMERA_ENABLED and (WEBCAM or not PC)),
